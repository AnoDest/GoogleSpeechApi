 ...
 * already exists.
 **/
public class FLACRecorderImpl extends Thread
{
  /***************************************************************************
   * Public constants
   **/
  ...
  /***************************************************************************
   * Simple class for reporting measured Amplitudes to user of FLACRecorderImpl
   **/
...
//Rate of recorded sound
   ...
   * Implementation
   **/
  public FLACRecorderImpl(String path, Handler handler)
  {
    mPath = path;
    mHandler = handler;
